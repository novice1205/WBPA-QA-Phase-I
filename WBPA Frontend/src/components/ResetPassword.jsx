...
const ResetPassword = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-center my-40 mx-9 p-5 md:p-14 poppins" style={{ backgroundColor: 'inherit' }}>
      {/* Left section */}
      <div className="w-full md:w-1/2 space-y-4 mb-8 md:mb-0">
        <h1 className="text-3xl md:text-4xl font-bold" style={{ color: '#2B6CB0' }}>Reset Your Password</h1>
      ...
      <div className="w-full md:w-1/2 max-w-md bg-white p-8 shadow-lg rounded-lg">
        <h2 className="text-2xl font-semibold mb-6" style={{ color: '#2B6CB0' }}>Create New Password</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <label htmlFor="password" className="block text-sm font-medium" style={{ color: '#4299E1' }}>New Password</label>
            <input
              id="password"
              type="password"
          ...
          <div className="space-y-2">
            <label htmlFor="confirmPassword" className="block text-sm font-medium" style={{ color: '#4299E1' }}>Confirm New Password</label>
            <input
              id="confirmPassword"
              type="password"
